<template>
  <div>
    <div class="demo-wrapper">
      <p>
        Sometimes the user shouldn't be able to interact with the component. The attribute
        <span
          class="code-word"
        >disabled</span> renders an unclickable checkbox which content can only be displayed, but not changed.
      </p>
